...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Zubair Ahmed designs and builds websites and sales funnels people stop scrolling for." },
      { property: "og:title", content: "Zubair Ahmed — Website & Sales Funnel Designer" },
      { property: "og:description", content: "Zubair Ahmed designs and builds websites and sales funnels people stop scrolling for." },
